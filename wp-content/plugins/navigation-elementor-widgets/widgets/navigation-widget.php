 ...
 * @since 1.0.0
 */
class Elementor_Navigation_Widget extends Base_Widget {
	...
	public function get_title() {
		return esc_html__( 'Navigation Project Nervo', 'elementor-navigation-widget' );
	}
	...
	protected function render() {
        ...
        $prev_client_name = get_post_meta( $prev_post->ID, 'client', true );
        $next_post = get_next_post();
        $next_client_name = get_post_meta( $next_post->ID, 'client', true );
		...
		<div class="elementor-post-navigation">
			<div class="elementor-post-navigation__prev elementor-post-navigation__link">
				<?php previous_post_link( '%link', $prev_arrow . '<span class="elementor-post-navigation__link__prev">' . $prev_label . $prev_title . '</span><span class="elementor-post-navigation__link__prev-client">' . $prev_client_name . '</span>', $in_same_term, '', $taxonomy ); ?>
			</div>
			...
			<div class="elementor-post-navigation__next elementor-post-navigation__link">
				<?php next_post_link( '%link', $next_arrow .  '<span class="elementor-post-navigation__link__next">' . $next_label . $next_title . '</span><span class="elementor-post-navigation__link__next-client">' . $next_client_name . '</span>', $in_same_term, '', $taxonomy ); ?>
			</div>
		</div>
		<?php
	}
